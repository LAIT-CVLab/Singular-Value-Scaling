...
def prdc50k_full(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    precision, recall, density, coverage = density_coverage.compute_prdc(opts, max_real=None, num_gen=50000)
...
def prdc50k(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    precision, recall, density, coverage = density_coverage.compute_prdc(opts, max_real=50000, num_gen=50000)
    return dict(precision=precision, recall=recall, density=density, coverage=coverage)
