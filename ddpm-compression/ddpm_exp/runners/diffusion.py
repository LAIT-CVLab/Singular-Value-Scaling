...
class Diffusion(object):
    ...
    def sample_fid(self, model):
        ...
        n_rounds = (total_n_samples - img_id) // (config.sampling.batch_size * accelerator.num_processes)
        
        # Distributed Sampling
        if accelerator.is_main_process:
            print("Samping {}x{}={} images with {} process(es)".format(n_rounds*config.sampling.batch_size, accelerator.num_processes, n_rounds*accelerator.num_processes*config.sampling.batch_size, accelerator.num_processes))
