...
do
    bash scripts/exp/celeba_our_sample_fid_pr${pruning_ratio}_thr${threshold}_temp.sh run/finetune_simple/celeba_ours_prune_ratio=${pruning_ratio}_T=${threshold}.pth/logs/post_training/ckpt_${step}.pth
done
