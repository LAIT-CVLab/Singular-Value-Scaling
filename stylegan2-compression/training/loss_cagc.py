...
class StyleGAN2Loss(Loss):
    def __init__(self, device, img_resolution, G_mapping, G_synthesis, D, G_teacher_mapping, G_teacher_synthesis, augment_pipe=None, style_mixing_prob=0.9, r1_gamma=10, pl_batch_shrink=2, pl_decay=0.01, pl_weight=2, kd_lpips_loss=True, kd_lpips_lambda=3.0, kd_l1_loss=True, kd_l1_lambda=3.0):
        super().__init__()
        self.device = device
