...
def training_loop(
    ...
    **kwargs
    ...
    loss = dnnlib.util.construct_class_by_name(device=device, img_resolution=training_set.resolution, **ddp_modules, **loss_kwargs) # subclass of training.loss.Loss
    phases = []
